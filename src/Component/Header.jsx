               ...
               {/* navbar logo */}
                ...
                {/* 手機版 */}
                    <ul className="navbar-nav ms-auto mb-5 d-lg-none text-primary-800">
                        ...
                        <li>
                            <a href="" className='py-3 w-100'>會員中心</a>
                        </li>
                        <li>
                                    ...
                                    <li>
                                        <Link to='/' className="dropdown-item px-6 py-2">
                                            <span className="fs-6 text-primary-700">
                                                <span class="material-symbols-outlined fill align-bottom me-2 text-primary-300">person</span>會員中心
                                            </span>
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to='/' className="dropdown-item px-6 py-2">
                                            <span className="fs-6 text-primary-700">
                                                <span class="material-symbols-outlined fill align-bottom me-2 text-primary-300">edit</span>修改會​員​資料
                                            </span>
                                        </Link>
                                    </li>
                                    <li>
